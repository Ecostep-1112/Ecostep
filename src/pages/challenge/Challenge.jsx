        ...
        {activeSubTab === 'habit' ? (
          <div className="mx-3 mt-4 space-y-4">
            ...
            <div className={`${cardBg} border-[0.3px] ${borderColor} rounded-xl p-5 relative`}>
              <div className="flex justify-between items-center mb-4">
                <h3 className={`${textColor} text-[15px] font-medium`}>챌린지</h3>
                {/* 랭크 아이콘 - 실제 랭킹 기준 */}
              ...
              {currentWeekStart && weeklyProgress[currentWeekStart] && 
               weeklyProgress[currentWeekStart].days.some(day => day !== null) ? (
                ...
                <div 
                  ...
                  <span className={`text-[15px] ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                ...
                >
                  <span className={`text-[15px] flex-1 text-center ${selectedChallenge ? (isDarkMode ? 'text-gray-300' : 'text-gray-700') : (isDarkMode ? 'text-gray-500' : 'text-gray-400')}`}>
                ...
                <>
                  ...
                  <div className="relative flex-1">
                    ...
                    >
                      <input
                        ...
                        className={`w-full ${inputBg} rounded-lg p-2 pr-8 text-[15px] ${textColor}`}
                        autoFocus
                      />
                    </div>
                    <button
                  ...
                  <button
                    ...
                    className={`w-9 h-9 rounded-lg text-[13px] font-medium transition-colors flex items-center justify-center ${
                    ...
                    <div key={challenge + index}>
                      ...
                      >
                        <button
                          ...
                          className={`flex-1 text-left text-[15px] ${textColor}`}
                        >
                          {challenge}
                        </button>
                  ...
                  return (
                    <div key={idx} className="flex flex-col items-center">
                      {isToday ? (
                        ...
                        <span className={`text-[13px] mb-1 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>
                          {dayName}
                        </span>
                      )}
              ...
              <div className="flex justify-between mb-2">
                ...
                <span className={`text-[13px] font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  {currentWeekStart && weeklyProgress[currentWeekStart] 
              ...
              <button
                ...
                className={`w-full h-9 rounded-lg text-[15px] font-medium transition-all ${
            ...
            <div className={`${cardBg} border-[0.3px] ${borderColor} rounded-xl p-4`}>
              <h3 className={`${textColor} text-[15px] font-medium mb-3`}>지난 챌린지</h3>
              {completedChallenges.length === 0 ? (
                <p className={`text-[15px] ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} text-center py-4`}>
                  아직 완료된 챌린지가 없습니다
                </p>
              ) : (
            ...
            <button
              ...
              className="w-full py-2 bg-red-500 hover:bg-red-600 text-white rounded-lg text-[15px] font-medium transition-colors mt-3"
            >
          ...
          <div className="mx-3 mt-4 space-y-4">
            ...
            <div className={`${cardBg} border-[0.3px] ${borderColor} rounded-xl p-5`}>
              <div className="flex justify-between items-center mb-4">
                <h3 className={`${textColor} text-[15px] font-medium`}>플라스틱 사용 한도 설정</h3>
              ...
              {goalSetDate && !canChangeGoal() ? (
                ...
                <div className="relative mb-4 dropdown-container">
                  ...
                  <button
                    ...
                    className={`w-full flex justify-between items-center rounded-lg px-3 py-2 text-[15px] ${tempPlasticGoal ? 'gradient-border' : ''} ${isDarkMode ? 'bg-gray-700' : 'bg-white'}`}
                    style={{
                    ...
                    >
                      ...
                      <div className={`p-2 border-b ${borderColor} flex gap-2`}>
                        <input
                          ...
                          } rounded px-2 py-1 text-[15px] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none transition-all focus:outline-none`}
                          style={{
                              ...
                              <React.Fragment key={goal}>
                                <div className={`flex items-center`}>
                                  <button
                                    ...
                                    className={`flex-1 text-left px-3 py-2 text-[15px] transition-colors ${
            ...
            {/* 플라스틱 사용 기록하기 */}
            <div className={`${cardBg} border-[0.3px] ${borderColor} rounded-xl p-4`}>
              <h3 className={`${textColor} text-[15px] font-medium mb-3`}>플라스틱 사용 기록하기</h3>
              <div className="space-y-3">
                <div className="relative dropdown-container">
                  {!showCustomPlastic ? (
                    ...
                    >
                      ...
                      >
                        <span className={`text-[15px] flex-1 text-center ${selectedPlasticItem ? (isDarkMode ? 'text-gray-300' : 'text-gray-700') : (isDarkMode ? 'text-gray-500' : 'text-gray-400')}`}>
                      ...
                      <div className="flex gap-2">
                        <div className="relative flex-1">
                          ...
                          >
                            ...
                            />
                            <span className={`absolute right-3 top-1/2 -translate-y-1/2 text-[15px] ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                              g
                            </span>
                          </div>
                        </div>
                        <button
                          ...
                          className={`flex-1 h-9 rounded-lg text-[13px] font-medium transition-colors flex items-center justify-center ${
                  ...
                  {showPlasticSelect && (
                    <>
                      ...
                      <div className={`absolute z-20 w-full mt-1 ${inputBg} rounded-lg p-2 max-h-60 overflow-y-auto scrollbar-hide shadow-lg border ${borderColor}`}>
                      <div className={`text-[13px] px-2 py-1 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'} text-center italic`}>
                          ...
                          return (
                            <div key={key}>
                              {(key !== 'custom' || category.items.length > 0) && (
                                <div className={`px-2 py-1 text-[13px] font-medium ${isDarkMode ? 'text-gray-400' : 'text-gray-500'}`}>
                                  {category.label}
                                </div>
                              )}
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    <label className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} text-[13px] text-center block`}>수량</label>
                    <div className={`flex items-center justify-center gap-1 mt-1 h-9 ${isDarkMode ? 'bg-gray-700' : 'bg-white'} rounded-lg px-1`}>
                      ...
                      <div className={`flex-1 h-7 flex items-center justify-center text-[15px] font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                        {plasticQuantity}
                      </div>
                      <button
                  ...
                  <div className="flex-1">
                    <label className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} text-[13px] text-center block`}>총 무게</label>
                    <div className={`h-9 mt-1 ${isDarkMode ? 'bg-gray-700' : 'bg-white'} rounded-lg flex items-center justify-center text-[15px] font-medium ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>
                      {(() => {
                        let totalWeight = 0;
                ...
                <button
                  ...
                  className={`w-full py-2 rounded-lg text-[15px] font-medium transition-colors ${
            ...
            {/* 사용량 분석 */}
            <div className={`${cardBg} border-[0.3px] ${borderColor} rounded-xl p-4`}>
              <h3 className={`${textColor} text-[15px] font-medium mb-3`}>사용량 분석</h3>
              <div className="space-y-2">
                {(() => {
                  ...
                  if (sortedItems.length === 0) {
                    return <p className={`text-[15px] ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} text-center`}>아직 기록된 데이터가 없습니다</p>;
                  }
            ...
            {/* 주간 사용량 그래프 */}
            <div className={`${cardBg} border-[0.3px] ${borderColor} rounded-xl p-4`}>
              <h3 className={`${textColor} text-[15px] font-medium mb-3`}>주간 사용량(지난 7일)</h3>
                ...
                {(() => {
                  ...
                  return weekData.map((data) => (
                    <div key={data.date} className="flex flex-col items-center flex-1">
                      ...
                      <span className={`text-[13px] ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} mt-1`}>
                        {data.day}
                      </span>
            ...
            <div className={`${cardBg} border-[0.3px] ${borderColor} rounded-xl p-3 h-[300px] flex flex-col`}>
              <h3 className={`${textColor} text-[15px] font-medium mb-1.5`}>이번 주 기록</h3>
                        ...
                        >
                          <div className="flex justify-between items-center">
                            <div className="flex items-center gap-1.5">
                              <span className={`text-[11px] transition-transform inline-block w-2 ${
                              ...
                              <span className={`text-[13px] ${textColor}`}>
                                {dayData.day}요일
                                <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'} ml-1`}>
                        ...
                        {isExpanded && dayData.records.length > 0 && (
                          <div className={`px-4 pb-0.5 ${isDarkMode ? 'text-gray-400' : 'text-gray-600'}`}>
                            {groupedItems.map((item, idx) => (
                              <div key={idx} className="text-[11px] py-0 pl-3">
              ...
              <div className={`mt-1.5 pt-1.5 border-t ${borderColor}`}>
                <div className="flex justify-between items-center">
                  <span className={`text-[15px] font-medium ${textColor}`}>주간 총계</span>
                  <span className={`text-[13px] ${textColor}`}>
                    {(() => {
                      const today = new Date(testDate || new Date());
                      const dayOfWeek = today.getDay();
            ...
            <div className={`${cardBg} border-[0.3px] ${borderColor} rounded-xl p-3 h-[300px] flex flex-col`}>
              <div className="flex justify-between items-center mb-1.5">
                <h3 className={`${textColor} text-[15px] font-medium`}>사용량</h3>
                <div className="relative dropdown-container">
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                      ...
                      {['일주일', '한 달', '6개월', '1년', '전체'].map((period, idx) => (
                        <React.Fragment key={period}>
                          <button
                            ...
                            className={`w-full text-left px-2 py-1.5 text-[13px] transition-colors whitespace-nowrap ${
                              usagePeriod === period
                                ? (isDarkMode ? 'bg-gray-700 text-white' : 'bg-gray-100 text-gray-900')
                                : (isDarkMode ? 'text-gray-200 hover:bg-gray-700' : 'text-gray-900 hover:bg-gray-50')
                            }`}
                          ...
                          return (
                            <div key={index} className="flex flex-col items-center flex-1 relative">
                              <div className="relative flex flex-col justify-end" style={{ height: `${graphHeight}px` }}>
                                ...
                                {isMax && item.value > 0 && (
                                  <span
                                    className={`text-[12px] font-medium absolute left-1/2 -translate-x-1/2 whitespace-nowrap ${
                                      isDarkMode ? 'text-gray-300' : 'text-gray-700'
                                    }`}
                                    style={{
                              ...
                              <span className={`text-[12px] ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} mt-4`}>
            ...
            <div className="mt-6 mx-3">
              <button
                ...
                } text-white rounded-lg text-[15px] font-medium transition-colors`}
              >
                🔄 테스트용 기록 리셋
              </button>
            </div>
