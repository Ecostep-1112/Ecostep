      ...
      <div className="min-h-full">
              ...
              <div className="flex items-stretch gap-2">
                ...
                <div className="flex-1 px-3 py-1.5 bg-white/5 rounded-lg">
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span className="text-[13px] font-medium text-white">{waterQuality}%</span>
                  </div>
        ...
        <div className={`mx-4 mt-4 p-3 ${isDarkMode ? 'bg-gray-800 border border-gray-700' : 'bg-gray-50 border border-gray-200'} rounded-xl`}>
          <div className="flex items-center justify-center gap-2">
            ...
            <span className={`text-[15px] font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
        ...
        <div className="mx-4 mt-4 mb-4">
          <div className={`${isDarkMode ? 'bg-gray-800 border border-gray-700' : 'bg-gray-50 border border-gray-200'} rounded-xl p-6`}>
            <div className="flex flex-col items-center">
              <span className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} text-[13px] mb-3`}>플라스틱 절약량</span>
              ...
              <div className="relative w-28 h-28 mb-3">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <p className="text-[25px] font-bold text-white drop-shadow-lg">{plasticSavedDisplay}</p>
                </div>
              </div>

              {treesEquivalent > 0 && (
                <p className={`${isDarkMode ? 'text-gray-400' : 'text-gray-500'} text-[13px] text-center`}>
              ...
              <div className="mt-4 w-full">
                ...
                {/* 나무가 없을 때 메시지 */}
                {treesEquivalent === 0 && (
                  <p className={`text-center text-[13px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'} mt-2`}>
                    챌린지를 완료하면 나무가 자랍니다
                  </p>
                )}
              </div>
        ...
        <div className={`mx-4 mt-4 mb-4 p-4 ${isDarkMode ? 'bg-gray-800 border border-gray-700' : 'bg-gray-50 border border-gray-200'} rounded-xl`}>
          <div className="flex items-center justify-between mb-2">
            <span className={`${isDarkMode ? 'text-gray-400' : 'text-gray-600'} text-[13px] font-medium`}>
              테스트용 플라스틱 절약량 조절
            </span>
          ...
          <div className="flex justify-between mt-1">
            <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>0g</span>
            <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>25kg</span>
            <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>50kg</span>
          </div>
          <div className="mt-2 text-center">
            <span className={`text-[12px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>
        ...
        <div className={`mx-4 mt-4 mb-4 p-4 ${isDarkMode ? 'bg-gray-800 border border-gray-700' : 'bg-gray-50 border border-gray-200'} rounded-xl`}>
          ...
          />
          <div className="flex justify-between mt-1">
            <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>0% (탁함)</span>
            <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>50%</span>
            <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>100% (맑음)</span>
          </div>
        </div>
      </div>
      ...
      {showSettingsPanel && selectedDecoration && (
        ...
        >
          <div className="flex items-center justify-between mb-1.5">
            <h3 className={`text-[13px] font-medium ${textColor}`}>
            ...
            <button
              ...
              className={`text-[13px] px-2 py-1 rounded-md ${isDarkMode ? 'bg-gray-700 text-gray-300 hover:bg-gray-600' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'} transition-colors`}
            >
              닫기
            </button>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div>
              <div className="flex items-center justify-between mb-0">
                <label className={`text-[13px] font-medium ${isDarkMode ? 'text-gray-300' : 'text-gray-700'}`}>
                  크기
                </label>
              ...
              <div className="flex justify-between mt-1">
                <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>50%</span>
                <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>100%</span>
                <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>150%</span>
              </div>
            </div>
            ...
            <div>
              ...
              />
              <div className="flex justify-between mt-1">
                <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>0°</span>
                <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>180°</span>
                <span className={`text-[11px] ${isDarkMode ? 'text-gray-500' : 'text-gray-400'}`}>360°</span>
              </div>
            </div>
            ...
            <div className="flex gap-2 mt-2">
              ...
              <button
                ...
                className={`flex-1 py-1.5 text-[13px] font-medium rounded-md transition-colors ${isDarkMode ? 'bg-gray-700 text-gray-300 hover:bg-gray-600 border border-gray-600' : 'bg-gray-100 text-gray-700 hover:bg-gray-200 border border-gray-300'}`}
              >
                기본값으로 리셋
              </button>
            ...
            {/* 안내 메시지 */}
            <div className="mt-2 text-center">
              <p className={`text-[13px] italic ${isDarkMode ? 'text-gray-400' : 'text-gray-600'} opacity-70`}>
